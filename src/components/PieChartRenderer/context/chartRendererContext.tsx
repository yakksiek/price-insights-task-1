...
const ChartRendererContext = createContext<IVisibilityContextType | undefined>(
  undefined,
);
...
export const ChartRendererContextProvider: React.FC<IProps> = ({
  children,
}) => {
  ...
  return (
    <ChartRendererContext.Provider value={{ state, toggleVisibility }}>
      {children}
